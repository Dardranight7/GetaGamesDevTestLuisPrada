...
public class MenuController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Return))
        {
            ...
            {
                DardranightCortinilla.DardraCortinilla.CargarEscena(2);
            }
    ...
    public void Saludar()
    {
        string nombreUsuario = GameData.gameData.GetUserInfo().nombre;
        if (nombreUsuario == "")
        {
    ...
    {
        GameData.gameData.GetUserInfo().nombre = _nombre;
